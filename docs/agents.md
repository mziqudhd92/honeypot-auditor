...
**honeypot-auditor** — MIT-licensed Python CLI that fingerprints low-interaction honeypots via non-destructive multi-protocol probes (**21** engines including MQTT, SNMP, Redis, and Elasticsearch). Outputs weighted **Honeyscore (0–100%)**, Rich table, JSON.
