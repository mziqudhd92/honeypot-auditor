...
**honeypot-auditor** — MIT-licensed Python CLI that fingerprints low-interaction honeypots via non-destructive multi-protocol probes (**23** engines including MQTT, SNMP, DNS, Redis, Elasticsearch, and IPP/CUPS). Outputs weighted **Honeyscore (0–100%)**, Rich table, JSON.
