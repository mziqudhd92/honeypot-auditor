...
**honeypot-auditor** — MIT-licensed Python CLI that fingerprints low-interaction honeypots via non-destructive multi-protocol probes (**25** engines including MQTT, SNMP, DNS, NTP, Redis, Elasticsearch, IPP/CUPS, and Memcached). Outputs weighted **Honeyscore (0–100%)**, Rich table, JSON.
