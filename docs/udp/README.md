...
Layout and transport scaffold for UDP protocol engines. **DNS** ships here;
**NTP / TFTP** follow in later PRs. Existing **SNMP** and **SIP** probes stay in
flat `probes/` until an optional relocate PR.
