...
`-p` maps well-known extras the same way: `443`/`8443` → HTTP (TLS), `8080`/`3128` → HTTP proxy, `139` → SMB, `993`/`1993` → IMAP (TLS/IMAPS), `5061` → SIP, `5000`/`5901` → VNC. Unknown numbers are probed as SSH.
